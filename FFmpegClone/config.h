...
#define FFMPEG_CONFIGURATION "--target-os=android --prefix=./android_single_lib/arm64-v8a --enable-cross-compile --arch=aarch64 --cc=/Users/niuzilin/Library/Android/ndk/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64/bin/aarch64-linux-android-gcc --cross-prefix=/Users/niuzilin/Library/Android/ndk/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64/bin/aarch64-linux-android- --sysroot=/Users/niuzilin/Library/Android/ndk/android-ndk-r14b/platforms/android-21/arch-arm64 --enable-neon --disable-hwaccels --enable-static --disable-shared --disable-runtime-cpudetect --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-asm --enable-small --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-debug --enable-gpl --disable-avdevice --disable-indevs --disable-outdevs --disable-avresample --extra-cflags='-Os -fpic -I./android_single_lib/arm64-v8a/include' --extra-ldflags='-lc -lm -ldl -llog -lgcc -lz -L./android_single_lib/arm64-v8a/lib' --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-avfilter --enable-network --enable-bsfs --enable-postproc --enable-filters --enable-encoders --enable-encoder=aac --disable-decoders --enable-decoder='h264,pcm_alaw' --disable-muxers --enable-muxer=mp4 --disable-parsers --enable-parser='aac,h264,' --disable-protocols --enable-protocol='file,concat' --disable-protocol='bluray,ffrtmpcrypt,gopher,icecast,librtmp*,libssh,md5,mmsh,mmst,sctp,srtp,subfile,unix' --enable-jni --enable-mediacodec --disable-demuxers --enable-demuxer='mp4,mov,concat,data' --cpu=armv8-a"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "./android_single_lib/arm64-v8a/share/ffmpeg"
#define AVCONV_DATADIR "./android_single_lib/arm64-v8a/share/ffmpeg"
